...
def tile_atom_to_shape_SF_blk(shape, sf_vec_size, blk_mn=128):
    """Global SF layout (like blockscaled_utils.tile_atom_to_shape_SF) but at a
    configurable M/N block granularity. blk_mn=128 -> stock (32x4) atom; blk_mn=64
    -> (32x2) atom (dense: m0 stride = (blk_mn//32)*4). Must match the reorder and
    the SF smem layout at the same blk_mn."""
    blk_sub = blk_mn // 32
